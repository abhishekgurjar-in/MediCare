            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  ...
                  Molestias, doloremque obcaecati illo facere blanditiis
                  voluptatem natus necessitatibus consectetur nulla debitis
                  maiores eveniet et sed doloribus atque ut. Expedita, natus
                  voluptatum!
                </p>
            ...
            <div className="py-[30px] px-5 ">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  ...
                  expert care . from the lab to the clinic .
                </p>
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              <h2 className="heading">
                Get A Viral Treatment <br /> anytime.
              </h2>
              <ul className="pl-4">
                ...
                <li className="text__para">
                  ...
                  online scheduling tool to select an a appointment time.
                </li>
              </ul>
              <Link to="/">
